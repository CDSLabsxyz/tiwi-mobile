...
import { searchItems, SearchableItem } from '@/utils/search';
    ...
    <View className="flex-1" style={{ backgroundColor: colors.bg }}>
      ...
      >
        ...
        >
          ...
          >
            <Image
              source="https://www.figma.com/api/mcp/asset/6a0efb41-7499-4ba8-b8d4-3ce5404cee8b"
          ...
          <View style={{ gap: 16 }}>
            ...
            >
              {Array.from({ length: 5 }).map((_, index) => {
                ...
                if (!action) {
                  return <View key={`empty-${index}`} style={{ width: 64, height: 55 }} />;
                }
                return (
                  <TouchableOpacity
                    key={action.id}
                  ...
                  >
                    ...
                    <Text
                      style={{
                        fontFamily: 'Manrope-Medium',
                        fontSize: 14,
                        color: action.disabled ? colors.bodyText : colors.titleText,
                        textAlign: 'center',
                      }}
                    >
                      {action.label}
                  ...
                  >
                    ...
                    <Text
                      style={{
                        fontFamily: 'Manrope-Medium',
                        fontSize: 14,
                        color: colors.bodyText, // Grayed out for coming soon
                        textAlign: 'center',
                      }}
                    >
                      {action.label}
