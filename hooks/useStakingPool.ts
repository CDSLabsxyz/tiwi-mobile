...
export function useStakingPool(
    ...
    const stats = useMemo((): OnChainPoolStats => {
        ...
        return {
            ...
            maxTvlCompact,
            limitsFormatted: poolConfig ? `${formatCompactNumber(Number(formatUnits(poolConfig.minStakeAmount || 0n, decimals)), {})}-${formatCompactNumber(Number(formatUnits(poolConfig.maxStakeAmount || 0n, decimals)), {})}` : 'N/A',
